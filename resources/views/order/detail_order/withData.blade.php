<div class="container-fluid mt--7">
        ...
        <div class="col">
            <div class="card shadow">
                <div class="card-header bdetail_order-0">
                    <div class="row">
                        <h3 class="col-9">Data Detail Order</h3>
                        <a class="btn btn-link btn-default " href="{{ route('order') }}">Kembali</a>
                        @if($detail_orders[0]->status_detail_order != 'Selesai')
                        <button type="button" class="btn btn-icon btn-3 btn-primary " data-toggle="modal"
                            data-target="#tambah-detail_order">

                            <span class="btn-inner--icon"><i class="fas fa-cart-plus mr-2"></i></span>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    @if($detail_order->status_detail_order == 'Selesai')
                                    ...
                                    <button type="button" class="btn btn-icon btn-3 btn-warning" data-toggle="modal"
                                        data-target="#edit-detail_order-{{ $detail_order->id_detail_order}}">
                                    ...
                                    <button type="button" class="btn btn-icon btn-3 btn-danger" data-toggle="modal"
                                        data-target="#hapus-detail_order-{{ $detail_order->id_detail_order }}">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="modal fade" id="tambah-detail_order" tabindex="-1" role="dialog"
                aria-labelledby="tambah-detail_order" aria-hidden="true">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="id_order" name="id_order"
                                                    readonly autocomplete="off" value="{{$detail_order->id_order}}">
                                            </div>
                                            <div class="form-group">
                                                <label class="form-control-label ">No Meja</label>
                                                <input type="number" class="form-control" id="no_meja" name="no_meja"
                                                    readonly autocomplete="off" value="{{$detail_order->no_meja}}">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="status_detail_order"
                                                    name="status_detail_order" required autocomplete="off">
                                            </div>
                                        </div>
                                </div>
...
<div class="row">
    <div class="col-md-4">
        <div class="modal fade" id="edit-detail_order-{{$detail_order->id_detail_order}}" tabindex="-1" role="dialog"
            aria-labelledby="edit-detail_order" aria-hidden="true">
            <div class="modal-dialog modal- modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-body p-0">
                        <div class="card bg-secondary shadow bdetail_order-0">
                            <div class="card-body px-lg-5 py-lg-5">
                                ...
                                <form role="form" method="POST"
                                    action="{{$id_order}}/edit/{{$detail_order->id_detail_order}}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="form-control-label ">ID Order</label>
                                                <input type="text" class="form-control" id="id_order" name="id_order"
                                                    readonly autocomplete="off" value="{{$id_order}}">
                                            </div>
                                            <div class="form-group">
                                                <label class="form-control-label ">No Meja</label>
                                                <input type="number" class="form-control" id="no_meja" name="no_meja"
                                                    readonly autocomplete="off" value="{{$no_meja->no_meja}}">
                                            </div>
                                            <div class="form-group">
                                                <label class="form-control-label">Menu</label>
                                                <select class="form-control" id="id_masakan" name="id_masakan" required>
                                                    <option value="{{ $detail_order->id_masakan }}">
                                                        {{ $masakan->nama_masakan }}</option>
                                                    @foreach($masakans as $masakan)
                                                    <option value="{{ $masakan->id_masakan }}">
                                                        {{$masakan ->nama_masakan}}</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="keterangan"
                                                    name="keterangan" required autocomplete="off"
                                                    value="{{ $detail_order->keterangan }}">
                                            </div>
                                            <div class="form-group">
                                                <label class="form-control-label ">Status detail Order</label>
                                                <input type="text" class="form-control" id="status_detail_order"
                                                    name="status_detail_order" required autocomplete="off"
                                                    value="{{ $detail_order->status_detail_order }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
...
<div class="col-md-4">
    <div class="modal fade" id="hapus-detail_order-{{$detail_order->id_detail_order}}" tabindex="-1" role="dialog"
            ...
            <div class="modal-content bg-gradient-danger">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-danger ml-auto"
                        href="/order/detail/{{$id_order}}/hapus/{{ $detail_order->id_detail_order }}">Hapus</a>
                </div>
