@extends('layouts.app' ,['activePage' => 'Masakan'])
...
<div class="container-fluid mt--7">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <button type="button" class="btn btn-icon btn-3 btn-warning" data-toggle="modal"
                                        data-target="#edit-masakan-{{ $masakan->id_masakan}}">
                                    ...
                                    <button type="button" class="btn btn-icon btn-3 btn-danger" data-toggle="modal"
                                        data-target="#hapus-masakan-{{ $masakan->id_masakan }}">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="modal fade" id="tambah-masakan" tabindex="-1" role="dialog" aria-labelledby="tambah-masakan"
                aria-hidden="true">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="nama_masakan"
                                                        name="nama_masakan" required autocomplete="off">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="status_masakan"
                                                        name="status_masakan" required autocomplete="off">
                                                </div>
                                            </div>
                                        </div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="modal fade" id="edit-masakan-{{$masakan->id_masakan}}" tabindex="-1" role="dialog"
                aria-labelledby="edit-masakan" aria-hidden="true">
                <div class="modal-dialog modal- modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-body p-0">
                            <div class="card bg-secondary shadow border-0">
                                <div class="card-body px-lg-5 py-lg-5">
                                    ...
                                    <form role="form" method="POST" action="masakan/edit/{{$masakan->id_masakan}}"
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="file-field form-group">
                                                    <div class="z-depth-1-half mb-4">
                                                        <img id="Imageuploaded-{{ $masakan->nama_masakan}}"
                                                            src="{{ asset('assets')}}/img/masakan/{{ $masakan->gambar_masakan }}"
                                                            class="img-fluid" style="width:780px; height:400px;">
                                                    </div>
                                                    <div class="d-flex justify-content-center">
                                                        <div class="btn btn-mdb-color btn-rounded float-left">
                                                            <input type="file"
                                                                onchange="readURL{{ $masakan->nama_masakan}}(this);"
                                                                id="gambar_masakan" name="gambar_masakan"
                                                                value="{{ $masakan->gambar_masakan }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="input-group input-group-md form-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text"
                                                            id="inputGroup-sizing-md">Rp.</span>
                                                    </div>
                                                    <input type="number" class="form-control" id="harga" name="harga"
                                                        require autocomplete="off" value="{{ $masakan->harga }}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="form-control-label">Status</label>
                                                <input type="text" class="form-control" id="status_masakan"
                                                    name="status_masakan" require autocomplete="off"
                                                    value="{{ $masakan->status_masakan  }}">
                                            </div>
                                        </div>
                                </div>
                                <div class="modal-footer">
...
<div class="col-md-4">
    <div class="modal fade" id="hapus-masakan-{{$masakan->id_masakan}}" tabindex="-1" role="dialog"
