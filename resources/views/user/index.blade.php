...
<div class="container-fluid mt--7">
                            ...
                            <tr>
                                    ...
                                    <div class="media align-items-center">
                                        <a href="#" class="mr-3">
                                            <img alt="Image placeholder"
                                                src="{{ asset('assets')}}/img/user/{{ $user->gambar_user }}"
                                ...
                                <td class="text-center">
                                    ...
                                    <button type="button" class="btn btn-icon btn-3 btn-danger" data-toggle="modal"
                                        data-target="#hapus-user-{{ $user->id }}">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="modal fade" id="tambah-user" tabindex="-1" role="dialog" aria-labelledby="tambah-user"
                aria-hidden="true">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="password" class="form-control" id="password"
                                                        name="password" require autocomplete="off">
                                                </div>
                                            </div>
                                        </div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="modal fade" id="edit-user-{{$user->id}}" tabindex="-1" role="dialog" aria-labelledby="edit-user"
                aria-hidden="true">
                <div class="modal-dialog modal- modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-body p-0">
                            <div class="card bg-secondary shadow border-0">
                                <div class="card-body px-lg-5 py-lg-5">
                                    ...
                                    <form role="form" method="POST" action="user/edit/{{$user->id}}"
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="file-field form-group">
                                                    <div class="z-depth-1-half mb-4">
                                                        <img id="Imageuploaded-{{ $user->name}}"
                                                            src="{{ asset('assets')}}/img/user/{{ $user->gambar_user }}"
    ...
    <div class="col-md-4">
        <div class="modal fade" id="hapus-user-{{$user->id}}" tabindex="-1" role="dialog"
